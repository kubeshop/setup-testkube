...
|    ✗     | `urlApiPrefix`  | API subdomain the Testkube Enterprise URL, if necessary                                                                                                                                                                               |
|    ✗     | `urlUiPrefix`   | Dashboard subdomain the Testkube Enterprise URL, if necessary                                                                                                                                                                         |
|    ✗     | `urlLogsPrefix` | Logs Server subdomain the Testkube Enterprise URL, if necessary                                                                                                                                                                       |
